  ...
  return (
    <section className="value-section" id="plans">
      <div className="value-inner">
        <p className="section-eyebrow reveal">VideoFlow by Fazinflo</p>
        <h2 className="value-title reveal">Why limit content when you can<br />scale at volume with VideoFlow.</h2>
        <div className="value-actions reveal">
          <a href="#" className="btn-primary-blue" id="plans-cta">Check plans now</a>
          <a href="#" className="btn-outline-white" id="plans-learn">Learn more</a>
        </div>
